  ...
  return (
    <div className="relative bg-white rounded-3xl px-4 py-6 text-center shadow-sm hover:shadow-lg transition-all duration-300 group">
      ...
      <a
        ...
        className="absolute top-4 right-4 w-9 h-9 bg-yellow-400 rounded-full flex items-center justify-center cursor-pointer hover:scale-110 transition"
      >
        <ArrowUpRight />
      </a>
      ...
      <div className="flex justify-center mb-5">
        <Link
          href={`/products/${product.id}`}
          className="w-36 h-36 md:w-48 md:h-48 rounded-full border-2 border-green-600 flex items-center justify-center overflow-hidden"
        >
          <Image
            src={product.image}
            alt={product.title}
            ...
            quality={70}
            placeholder="blur"
            blurDataURL={product.blur || "/placeholder-blur.jpg"}
