...
const FeatureCard = ({ icon, title, description }: FeatureItem) => (
  <motion.div variants={fadeUp} className="flex items-start gap-3 font-signika">
    <div className="flex-shrink-0 w-12 h-12 bg-[#E8D44D] rounded-full flex items-center justify-center">
      <Image src={icon} alt={title} width={28} height={28} />
    </div>
    <div>
...
const WhyChooseSection = () => {
  return (
    <section
      id="services"
      className="bg-[#F5F0E8] py-16 px-4 sm:px-8 lg:px-16 xl:px-24 overflow-hidden"
    >
      <motion.div
        variants={container}
        initial="hidden"
      ...
      >
        ...
        <div className="flex flex-col items-center text-center">
          <motion.div variants={fadeUp}>
            <div className="flex gap-2 shadow-sm bg-white px-4 py-[5px] rounded-2xl mb-4">
          ...
          <motion.h2
            variants={fadeUp}
            className="text-3xl font-signika sm:text-4xl lg:text-5xl font-extrabold text-gray-900 leading-tight max-w-2xl"
          >
            Choose What&apos;s Perfect For Your Field
          </motion.h2>
        </div>
        ...
        <div className="mb-16">
          ...
          >
            <div className="relative w-[240px] h-[280px] sm:w-[280px] sm:h-[320px] md:w-[300px] md:h-[350px]">
              <Image
                src="/center-plant.svg"
                alt="Hanging coconut plant arrangement"
                fill
